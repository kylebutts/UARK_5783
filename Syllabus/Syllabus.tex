...
\begin{table}[!ht]
  ...
  \begin{tabular}{@{\extracolsep{5pt}} lll @{}}
    ...
    \faPaperPlaneO & Email & \href{mailto:kbutts@uark.edu?subject=[ECON5783] }{kbutts@uark.edu}  \\
    ...
    \faClockO & Lecture & WJWH 0333 MW 1--2:15pm \\
    \faBuildingO & Office Hours & WCOB 408 MW 11am--1pm \\
    \faChevronRight & Course Materials & \url{https://github.com/kylebutts/UARK_5783/} \\
...
I have written my opinions about AI use in this class in a separate document. 
In short, it is your perogative to use AI to help you better learn the material.
It is my job to design the course to make sure you can use AI to learn, but not use it to do all the work for you. 

You have access to all the course material via the github repository. 
I encourage you to download all the material and feed it to your LLM of choice. 
It can be a very effective tutor, so ssk it questions about the material!
